...
This folder defines all source code for the 'Project_SDP' pipeline:
...
* Take a look at the sample under "sample_users_project_sdp.py" to get familiar with the syntax.
